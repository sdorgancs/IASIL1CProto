...
/**
 * ComplexArray defines an array of double complex
 * It is a utility class to simplify in place computation and keeping compatibility with Hipparchus library complex format
 * ComplexArray data as stored in a double array such as  Real = data[i], Imaginary = data[i+1]
 * @author sdorgan
 */
public final class ComplexArray implements Serializable{
    ...
    //Complex array stored as double array: Real = data[i], Imaginary = data[i+1]
    private double[] data;

    /**
     * Constructs a complexe array of length <code>size</code>
     * @param size length of the complex array
     */
    ...
    /**
     * Wraps a complex array stored as a double array: Real = data[i], Imaginary = data[i+1]
     ...
     * @param reals an array of real values
     ...
     * @param reals an array of imaginary values
     ...
     * @param f the combiner (ex: a.combine((c, c2) -> c.multiply(c2)) returns this = this * a2) 
     * @param a2 the array to be combined with
     */
    ...
    /**
     * Map elements between  <code>firstIndex</code> and <code>lastIndex</code> with <code>function</code> 
     * @param function a unary operator
     * @param firstIndex first index is included
     * @param lastIndex last index is excluded
     */
     ...
     * @param initValue initial value of the accumulator
     * @param firstIndex index of the first element to reduce
     * @param lastIndex index of the last element to reduce (excluded)
    ...
    /**
     * Returns the index of the maximum value and the maximum value of this array. 
     * @param f function used to compared the elements (ex a.max(Complex::Abs))
     * @return the index of the maximum value and the maximum value of this array. 
     */
    ...
    /**
     * Returns the index of the minimum value and the minimum value of this array. 
     * @param f function used to compared the elements (ex a.min(Complex::Abs))
     * @return the index of the minimum value and the minimum value of this array. 
     */
