...
public class TupleAdaptor {
    ...
    public Pair<String, ITupleApi> createTuple(Object outpout, Object fieldValue) throws IllegalAccessException, InvocationTargetException, NoSuchMethodException{
